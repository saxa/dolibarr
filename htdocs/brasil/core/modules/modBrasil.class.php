...
/**
 * 	\defgroup   mymodule     Module Brasil
 *  \brief      Example of a module descriptor.
 *				Such a file must be copied into htdocs/mymodule/core/modules directory.
 *  \file       htdocs/mymodule/core/modules/modBrasil.class.php
 *  \ingroup    mymodule
 *  \brief      Description and activation file for module Brasil
 */
include_once(DOL_DOCUMENT_ROOT ."/core/modules/DolibarrModules.class.php");


/**
 *  Description and activation class for module Brasil
 */
class modBrasil extends DolibarrModules
{
	/**
	...
	function modBrasil($db)
	{
		...
		$this->description = "Module Brasil aims at adding ability to Dolibarr to function with the taxes used in Brazil.";
