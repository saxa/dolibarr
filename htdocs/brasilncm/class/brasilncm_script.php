...
/**
 *      \file       brasilncm/brasilncm_script.php
 *		\ingroup    brasilncm
...
// Examples for manipulating class brasilncm_class
require_once(DOL_DOCUMENT_ROOT."/../brasilncm/brasilncm.class.php");
$myobject=new Brasilncm($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."brasilncm";
